...
public class PersonXmlRepository {
	private static final Logger log = LogManager.getLogger(PersonXmlRepository.class);

	public List<Person> parsePersonsFromXml(String filename) throws RepositoryException {
		...
		try (InputStream inputStream = ClassLoader.getSystemResourceAsStream(filename)) {
			...
			throw new RepositoryException("Error reading names from file " + filename, e);
		}
	}
