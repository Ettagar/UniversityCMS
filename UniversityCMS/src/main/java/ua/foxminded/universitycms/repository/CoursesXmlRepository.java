...
@Repository
public class CoursesXmlRepository {
	private static final Logger log = LogManager.getLogger(CoursesXmlRepository.class.getName());

	public Map<String, String> parseCoursesFromXml(String filename) throws RepositoryException {
